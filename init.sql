...
CREATE TABLE profiles (profile VARCHAR(64), username VARCHAR(128), password VARCHAR(255), domain VARCHAR(255), exts TEXT, ignore_exts \
...
load data infile \
  '/var/www/OpenDLP/web/etc/default_regexes' into table regexes \
  fields terminated by ':';

create user 'OpenDLP'@'localhost' identified by '';
